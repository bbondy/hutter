...
help:
	...
	@echo "make roundtrip INPUT=path CODEC=huffman|huffman-o1|lz77|ppm-o1|ppm-o2|ppm|ppm-o4|ppm-o5|ppm-o6|ppm-byte-mix|ppmd|ppm-bit|ppm-bit-o16|ppm-bit-o32|ppm-bit-o64|ppm-bit-mix|ppm-mix   Compress + decompress + verify"
	@echo "                              Note: ppm-oN is byte-level PPM; ppmd is byte-level exclusion-based PPMD-style; ppm-bit-oN is bit-level PPM; ppm-mix uses both"
	@echo "make bench INPUT=path CODEC=huffman|huffman-o1|lz77|ppm-o1|ppm-o2|ppm|ppm-o4|ppm-o5|ppm-o6|ppm-byte-mix|ppmd|ppm-bit|ppm-bit-o16|ppm-bit-o32|ppm-bit-o64|ppm-bit-mix|ppm-mix       Print size stats for a corpus"
	@echo "                              Note: ppm-oN is byte-level PPM; ppmd is byte-level exclusion-based PPMD-style; ppm-bit-oN is bit-level PPM; ppm-mix uses both"
	@echo "cargo run --release -- profile INPUT   Benchmark ppm-match-mix internal model combinations"
