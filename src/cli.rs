...
pub fn print_usage(program: &str) {
    eprintln!("usage:");
    eprintln!(
        "  {program} compress [--codec huffman|huffman-o1|lz77|ppm-o1|ppm-o2|ppm|ppm-o4|ppm-o5|ppm-o6|ppm-byte-mix|ppm-bit|ppm-bit-o16|ppm-bit-o32|ppm-bit-o64|ppm-bit-mix|ppm-mix|wikimix5] <input> <archive>"
    );
    eprintln!(
        "  note: ppm-oN is byte-level PPM; ppm-bit-oN is bit-level PPM; ppm-mix uses both"
    );
